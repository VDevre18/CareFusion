        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MRN = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StorageUri = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exams_PatientId_StudyDateUtc",
                table: "Exams",
                columns: new[] { "PatientId", "StudyDateUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_PatientNotes_PatientId_NoteDate",
                table: "PatientNotes",
                columns: new[] { "PatientId", "NoteDate" });

            migrationBuilder.CreateIndex(
                name: "IX_PatientReports_PatientId_ReportType",
