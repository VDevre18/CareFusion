-- RUN THIS SCRIPT TO FIX THE CURRENT DATABASE ISSUE
-- This script adds the missing DefaultClinicSiteId column to the Users table
...
PRINT ''Migration completed successfully - You can now login without errors'';
');